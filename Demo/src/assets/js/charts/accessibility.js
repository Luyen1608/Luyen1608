...
(function(b) {
    ...
    v(b, "Accessibility/Utils/ChartUtilities.js", [b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]], function(b, e) {
        ...
        return {
            getChartTitle: function(a) {
                return m(a.options.title.text || a.langFormat("accessibility.defaultChartTitle", {
                    chart: a
                }))
            },
    ...
    v(b, "Accessibility/Components/LegendComponent.js", [b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/Legend.js"], b["Core/Utilities.js"], b["Accessibility/AccessibilityComponent.js"],
        b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/HTMLUtilities.js"]
        ...
        q(b.prototype, {
            ...
            updateLegendTitle: function() {
                var a =
                    this.chart,
                    c = f((a.legend && a.legend.options.title && a.legend.options.title.text || "").replace(/<br ?\/?>/g, " "));
    ...
    v(b, "Accessibility/Components/MenuComponent.js", [b["Core/Chart/Chart.js"], b["Core/Utilities.js"], b["Accessibility/AccessibilityComponent.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function(b, e, r, p, u, t) {
        ...
        b.prototype.highlightLastExportItem = function() {
            ...
            if (this.exportDivElements)
                for (b =
                    this.exportDivElements.length; b--;)
        ...
        e(b.prototype, {
            ...
            onChartRender: function() {
                ...
                c && !1 !== c.enabled && c.accessibility && c.accessibility.enabled && d && d.element && (this.exportProxyGroup = this.addProxyGroup("all" ===
                    a.landmarkVerbosity ? {
                        ...
                        role: "region"
                    } : {}), a = l(this.chart), this.exportButtonProxy = this.createProxyButton(a, this.exportProxyGroup, {
            ...
            addAccessibleContextMenuAttribs: function() {
                ...
                }), a = a[0].parentNode, a.removeAttribute("aria-hidden"), a.setAttribute("aria-label", b.langFormat("accessibility.exporting.chartMenuLabel", {
                    chart: b
                })))
            },
            getKeyboardNavigation: function() {
            ...
            onKbdNext: function(b) {
                var a =
                    ...
                    c = a.options.accessibility;
                b = b.response;
                for (var d = (a.highlightedExportItemIx || 0) + 1; d < a.exportDivElements.length; ++d)
                    if (a.highlightExportItem(d)) return b.success;
    ...
    v(b, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js",
        ...
        function(b, e, r, p, u, t, l, m, h) {
            ...
            r.prototype.highlightFirstValidPoint = function() {
                ...
                if (c && d) {
                    for (var f = b; f < d; ++f)
                        if (!a(c[f])) return c[f].highlight();
                    for (; 0 <= b; --b)
                        if (!a(c[b])) return c[b].highlight()
                }
                return !1
            };
    ...
    v(b, "Accessibility/Components/SeriesComponent/SeriesDescriber.js",
        [b["Accessibility/Components/AnnotationsA11y.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/FormatUtilities.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Tooltip.js"], b["Core/Utilities.js"]],
        function(b, e, r, p, u, t) {
            ...
            function f(a) {
                var b = d(a),
                    c = (a.series.xAxis || {}).categories && I(a.category) && ("" + a.category).replace("<br/>", " "),
            ...
            function E(a) {
                ...
                return a.isNull ? b.chart.langFormat("accessibility.series.nullPointValue", {
                    point: a
                }) : b.pointArrayMap ? n(a, d, c) : d + k + c
            }
            ...
            function C(a) {
                var b = a.series,
                    ...
                    d = (b = G(b.xAxis && b.xAxis.options.accessibility && b.xAxis.options.accessibility.enabled, !c.angular)) ?
                    f(a) : "";
                a = {
                    point: a,
            ...
            function v(a) {
                ...
                (b || c) && a.points.forEach(function(a) {
                    ...
                    if (!(c = a.graphic && a.graphic.element) && (c = a.series && a.series.is("sunburst"), c = a.isNull && !c)) {
                        ...
                        f = f ? {
                            x: G(a.plotX, f.plotX, 0),
                            y: G(a.plotY, f.plotY, 0)
                        } : {
                            x: G(a.plotX, 0),
                            y: G(a.plotY, 0)
                        };
    ...
    v(b, "Accessibility/Utils/Announcer.js", [b["Core/Globals.js"], b["Core/Renderer/HTML/AST.js"], b["Accessibility/Utils/DOMElementProvider.js"], b["Accessibility/Utils/HTMLUtilities.js"]], function(b, e, r, p) {
        ...
        p = function() {
            ...
            b.prototype.addAnnounceRegion = function(b) {
                var h = this.chart.announcerContainer || this.createAnnouncerContainer(),
    ...
    v(b, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [b["Core/Series/Series.js"], b["Core/Utilities.js"]], function(b, e) {
        ...
        return function() {
            p(b, "render", function() {
                ...
                if (e) {
                    if (b.marker && !1 === b.marker.enabled && (this.a11yMarkersForced = !0, r(this.options)), this._hasPointMarkers && this.points && this.points.length)
                ...
                } else this.a11yMarkersForced && (delete this.a11yMarkersForced, (b = this.resetA11yMarkerOptions) && u(!0, this.options, {
                    marker: {
                        enabled: b.enabled,
                        states: {
                            normal: {
    ...
    v(b, "Extensions/RangeSelector.js", [b["Core/Axis/Axis.js"], b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/DefaultOptions.js"], b["Core/Color/Palette.js"], b["Core/Renderer/SVG/SVGElement.js"], b["Core/Utilities.js"]], function(b, e, r, p, u, t, l) {
        ...
        n(h, {
            rangeSelector: {
                ...
                inputStyle: {
                    color: u.highlightColor80,
                    cursor: "pointer"
                },
                labelStyle: {
                    color: u.neutralColor60
                }
            }
        });
        n(h.lang, {
        ...
        var x = function() {
            ...
            e.prototype.clickButton = function(a, d) {
                ...
                if (null !== A && null !== h) {
                    ...
                    z && (this.forcedDataGrouping = !0, b.prototype.setDataGrouping.call(g || {
                        chart: this.chart
                    }, z, !1), this.frozenStates = f.preserveDataGrouping);
                    if ("month" === m || "year" === m)
                        if (g) {
                            m = {
                                range: f,
                        ...
                        if (g) "undefined" === typeof h && (A = Number.MAX_VALUE, h = Number.MIN_VALUE, k.series.forEach(function(a) {
                            a = a.xData;
                            A = Math.min(a[0], A);
                            h = Math.max(a[a.length - 1], h)
                        }), d = !1), n = this.getYTDExtremes(h, A, k.time.useUTC), p = x = n.min, n = n.max;
                        else {
                    ...
                    if (g) g.setExtremes(p, n, B(d, !0), void 0, {
            ...
            e.prototype.updateButtonStates = function() {
                ...
                a.buttonOptions.forEach(function(b, k) {
                    ...
                    ("month" === A || "year" === A) && f + 36E5 >= 864E5 * {
                        ...
                        month: 31,
                        year: 366
                    } [A] * G + l ? e = !0 : "ytd" === A ? (e = y - m + l === f, u = !b) : "all" === A && (e = d.max - d.min >= n - h, t = !b && x && e);
                    A = !p && (O || r || t || g);
            ...
            e.prototype.setInputValue = function(a, b) {
                ...
                if (f) {
                    ...
                    a && a.attr({
                        text: k.dateFormat(d.inputDateFormat, g)
                    })
                }
            };
            ...
            e.prototype.drawInput = function(b) {
                ...
                z = q.label(z, 0).addClass("highcharts-range-label").attr({
                    padding: z ? 2 : 0,
                ...
                d.styledMode || (z.css(v(y, x.labelStyle)), q.css(v({
                    color: u.neutralColor80
                }, y, x.inputStyle)), a(l, n({
                    position: "absolute",
                    border: 0,
            ...
            e.prototype.renderButtons = function() {
                ...
                this.buttonOptions.forEach(function(c, d) {
                    ...
                    b[d] = f.button(c.text, 0, 0, function(b) {
                        ...
                        !1 !== k && a.clickButton(d);
                        a.isActive = !0
                    }, e, n && n.hover, n && n.select, n && n.disabled).attr({
                        "text-align": "center",
                        width: y
                    }).add(a.buttonGroup);
            ...
            e.prototype.alignElements = function() {
                var a = this,
                    ...
                    h = this.zoomText,
                    n = d.options,
                    y = n.exporting && !1 !== n.exporting.enabled && n.navigation && n.navigation.buttonOptions;
                n = g.buttonPosition;
                ...
                if (f && n && m) {
                    ...
                    b = 0;
                    e && (b = l(e, m), "left" === m.align ? z = x : "right" === m.align && (z = -Math.max(d.axisOffset[1], -b)), e.align({
                        y: m.y,
                    ...
                    if ("top" === q) g.floating && (l = 0), d.titleOffset && d.titleOffset[0] && (l = d.titleOffset[0]), l += d.margin[0] - d.spacing[0] || 0;
                    else if ("middle" === q)
                        if (m.y === n.y) l = e;
                        else if (m.y || n.y) l = 0 > m.y || 0 > n.y ? l - Math.min(m.y, n.y) : e - b;
                ...
                var n = function(b) {
                        if (f && d) {
                            var c = f.alignAttr.translateX +
                                f.alignOptions.x - a + f.getBBox().x + 2,
                    ...
                    m = function() {
                        f && d && f.attr({
                            translateX: f.alignAttr.translateX + (c.axisOffset[1] >= -a ? 0 : -a),
                ...
                var b = this.buttons,
                    ...
                    h = function(a) {
                        return {
                            ...
                            paddingRight: B(k.buttonTheme.paddingRight,
                                g.padding, 8)
                        }
                    };
                e && e.hide();
        ...
        if (!r.RangeSelector) {
            ...
            q(e, "update", function(a) {
                ...
                a && (K(this), b = b && b.verticalAlign || a.options && a.options.verticalAlign, a.options.floating || ("bottom" === b ? this.extraBottomMargin = !0 : "middle" !== b && (this.extraTopMargin = !0)), this.extraBottomMargin !== d || this.extraTopMargin !== f) && (this.isDirtyBox = !0)
            });
            q(e, "render", function() {
        ...
        r(e.prototype, {
            ...
            defaultBeforeChartFormatter: function() {
                var a = this.chart,
                    ...
                    f = a.sonify && a.options.sonification && a.options.sonification.enabled,
                    e = "highcharts-a11y-sonify-data-btn-" +
                    a.index,
                    g = "hc-linkto-highcharts-data-table-" + a.index,
                    h = d(a),
                    m = a.langFormat("accessibility.screenReaderSection.annotations.heading", {
                        chart: a
                    });
                c = {
    ...
    v(b, "Accessibility/Components/ContainerComponent.js", [b["Accessibility/AccessibilityComponent.js"],
        b["Accessibility/KeyboardNavigationHandler.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Globals.js"], b["Accessibility/Utils/HTMLUtilities.js"], b["Core/Utilities.js"]
    ], function(b, e, r, p, u, t) {
        ...
        r(p.prototype, {
            ...
            handleSVGTitleElement: function() {
                var b = this.chart,
                    ...
                    c = q(b.langFormat("accessibility.svgContainerTitle", {
                        chartTitle: m(b)
                    }));
                if (c.length) {
        ...
        function(b) {
            ...
            function u(b) {
                b.axes.forEach(function(e) {
                    (e = e.options) && e.description && (e.accessibility = e.accessibility || {}, e.accessibility.description = e.description, l(32, !1, b, {
            ...
            return function(b) {
                ...
                r(b, ["accessibility", "keyboardNavigation"], ["accessibility", "keyboardNavigation", "seriesNavigation"], {
    ...
    v(b, "Accessibility/A11yI18n.js", [b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/FormatUtilities.js"], b["Core/Utilities.js"]], function(b, e, r, p) {
        function u(b,
            ...
            if (-1 < h) {
                ...
                b = "";
                if (e = e[c[0]])
                    for (h = isNaN(h) ? e.length : h, h = 0 > h ? e.length + h : Math.min(h, e.length), c = 0; c < h; ++c) b += g + e[c] + a;
                return b.length ? b : ""
            }
            if (-1 < g) {
    ...
    v(b,
        "Accessibility/FocusBorder.js", [b["Core/Chart/Chart.js"], b["Core/Globals.js"], b["Core/Renderer/SVG/SVGElement.js"], b["Core/Renderer/SVG/SVGLabel.js"], b["Core/Utilities.js"]],
        function(b, e, r, p, u) {
            function t(a) {
            ...
            function l(b) {
                ...
                b.focusBorderUpdateHooks || (b.focusBorderUpdateHooks = {}, a.forEach(function(a) {
                    a += "Setter";
            ...
            q(r.prototype, {
                addFocusBorder: function(a,
                    ...
                    this.focusBorder = this.renderer.rect(h, m, q, r, parseInt((b && b.r || 0).toString(), 10)).addClass("highcharts-focus-border").attr({
                        zIndex: 99
            ...
            b.prototype.setFocusToElement = function(a, b) {
                ...
                (b = b || a.element) && b.focus && (b.hcEvents && b.hcEvents.focusin || h(b, "focusin", function() {}), b.focus(), c.hideBrowserFocusOutline && (b.style.outline = "none"));
                this.focusElement && this.focusElement.removeFocusBorder();
                this.focusElement = a;
    ...
    v(b, "Accessibility/Accessibility.js", [b["Core/Chart/Chart.js"], b["Accessibility/Utils/ChartUtilities.js"], b["Core/Globals.js"], b["Accessibility/KeyboardNavigationHandler.js"], b["Core/DefaultOptions.js"], b["Core/Series/Point.js"], b["Core/Series/Series.js"],
        ...
        b["Accessibility/HighContrastTheme.js"], b["Accessibility/Options/Options.js"], b["Accessibility/Options/LangOptions.js"], b["Accessibility/Options/DeprecatedOptions.js"], b["Accessibility/Utils/HTMLUtilities.js"]
    ], function(b, e, r, p, u, t, l, m, h, q, g, a, c, d, f, n, v, C, N, J, H, F, B) {
        function w(a) {
            this.init(a)
        }
        var y = r.doc,
