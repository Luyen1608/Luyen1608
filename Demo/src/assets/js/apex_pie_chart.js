        ...
        C = function() {
            ...
            return a(t, [{
                ...
                value: function(t, e) {
                    ...
                    var M = P.bbox();
                    if (s) {
                        var I = this.graphics.drawRect(M.x - v, M.y - C, M.width + v + w, M.height + A + C, p, d || "transparent", 1, g, f, u);
                ...
                value: function(t, e) {
                    ...
                    for (var n = 0, l = 0; n < t.length; n++, l++) {
                        ...
                        for (var C = a.group({
                            ...
                            z && L.add(z), f = M.y, u = M.x, P > 0 && m.push(u + A / 2), x.push(f);
        ...
        dt = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    ...
                    })), r.globals.isXNumeric && (m = (v = this.closestInMultiArray(g, u, y, b)).index, f = v.j, null !== m && (y = r.globals.seriesXvalues[m], f = (v = this.closestInArray(g, y)).index)), r.globals.capturedSeriesIndex = null === m ? -1 : m, (!f || f < 1) && (f = 0), r.globals.isBarHorizontal ? r.globals.capturedDataPointIndex = x : r.globals.capturedDataPointIndex = f, {
                        capturedSeries: m,
            ...
            return a(t, [{
                ...
                value: function(t) {
                    for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, f = t.yArrj, x = this.w, m = new b(this.ctx), v = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = p.isNumber(x.globals.minYArr[i]) ? x.globals.minYArr[i] : x.globals.minY, L = x.globals.dataPoints > 1 ? x.globals.dataPoints - 1 : x.globals.dataPoints, P = 0; P < L; P++) {
                        ...
                        c = z.areaPaths, h = z.linePaths, o = z.pX, n = z.pY, k = z.areaPath, w = z.linePath, this.appendPathFrom && (A += m.line(s, this.zeroY), S += m.line(s, this.zeroY)), this.handleNullDataPoints(e, I, a, P, i), this._handleMarkersAndLabels({
                            pointsPos: I,
                            series: e,
                            x: s,
                            y: r,
    ...
    var Tt, Mt, It = function() {
        ...
        Xt = function() {
            ...
            return a(t, [{
                ...
                value: function(t) {
                    for (var e = t.currentMillisecond, i = t.currentSecond, a = t.currentMinute, s = t.currentHour, r = t.currentDate, o = t.currentMonth, n = t.currentYear, l = t.minutesWidthOnXAxis, h = t.secondsWidthOnXAxis, c = t.numberOfMinutes, d = a + 1, g = r, u = o, f = n, x = s, b = (60 - i - e / 1e3) * h, m = 0; m < c; m++) d >= 60 && (d = 0, 24 === (x += 1) && (x = 0)), this.timeScaleArray.push({
                        position: b,
                        value: d,
                        unit: "minute",
                        hour: x,
                ...
                value: function(t) {
                    for (var e = t.currentMillisecond, i = t.currentSecond, a = t.currentMinute, s = t.currentHour, r = t.currentDate, o = t.currentMonth, n = t.currentYear, l = t.secondsWidthOnXAxis, h = t.numberOfSeconds, c = i + 1, d = a, g = r, u = o, f = n, x = s, b = (1e3 - e) / 1e3 * l, m = 0; m < h; m++) c >= 60 && (c = 0, ++d >= 60 && (d = 0, 24 === ++x && (x = 0))), this.timeScaleArray.push({
                        position: b,
                        value: c,
                        unit: "second",
                        hour: x,
