        ...
        A(c.prototype, {
            ...
            getSVG: function(a) {
                ...
                this.axes.forEach(function(a) {
                    ...
                    a.options.isInternal || (h[a.coll] || (h[a.coll] = !0, f[a.coll] = []), f[a.coll].push(p(a.userOptions, {
                        visible: a.visible
                    })))
                });
            ...
            contextMenu: function(a, b, f, d, c, h, k) {
                var g = this,
                    ...
                    w = Math.max(c, h);
                if (!l) {
                    g.exportContextMenu = g[v] = l = y("div", {
                            className: a
                        }, {
                            position: "absolute",
                            zIndex: 1E3,
            ...
            addButton: function(a) {
                ...
                if (!1 !== d.enabled && d.theme) {
                    ...
                    var v = f.button(d.text,
                        0, 0, C, g, m, k).addClass(a.className).attr({
