    ...
    k(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function(a) {
        ...
        a = a.downloadURL = function(a, l) {
            ...
            if ("string" ===
                ...
                if (d && "string" === typeof a && 0 === a.indexOf("data:application/pdf") || g || 2E6 < a.length)
                    if (a = t(a) || "", !a) throw Error("Failed to convert to blob");
                if ("undefined" !== typeof c.download) c.href = a, c.download = l, p.body.appendChild(c), c.click(), p.body.removeChild(c);
                else try {
        ...
        d.prototype.getTableAST = function(a) {
            ...
            c.push(function(a, b, c) {
                ...
                if (e) {
                    for (e = []; h < c; ++h) {
                        ...
                        m === k ? ++g : g ? (e.push(n("th", "highcharts-table-topheading", {
                            scope: "col",
                            colspan: g + 1
                        }, m)), g = 0) : (m === b[h] ? d.exporting.useRowspanHeaders ? (k = 2, delete b[h]) : (k = 1, b[h] = "") : k = 1, m = n("th", "highcharts-table-topheading", {
                            scope: "col"
                        }, m), 1 < k && m.attributes && (m.attributes.valign = "top", m.attributes.rowspan = k), e.push(m))
                    }
                    f.push({
                        tagName: "tr",
                        children: e
                ...
                if (b) {
                    e = [];
                    h = 0;
                    for (c = b.length; h < c; ++h) "undefined" !== typeof b[h] && e.push(n("th", null, {
                        scope: "col"
                    }, b[h]));
                    f.push({
                        tagName: "tr",
            ...
            a.forEach(function(a) {
                for (var c = [], d = 0; d < b; d++) c.push(n(d ? "td" : "th", null, d ? {} : {
                    scope: "row"
                }, a[d]));
                v.push({
                    tagName: "tr",
